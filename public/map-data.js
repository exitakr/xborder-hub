// X Border Hub - Migration data
// Display labels use full names like "Singapore", "Tokyo" instead of codes
const regions = {
  asia: {
    label: 'ASIA-PAC', weekTotal: 234,
    cities: [
  ...
  namerica: {
    label: 'NORTH AMERICA', weekTotal: 41,
    cities: [
